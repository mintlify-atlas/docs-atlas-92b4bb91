...
<CardGroup cols={2}>
  <Card title="Working with Workspaces" icon="folder" href="/workspaces">
    Share data between Tasks using Workspaces and persistent volumes
  </Card>
  <Card title="Task Results" icon="output" href="/task-results">
    Pass data between Tasks using results and parameters
  </Card>
  <Card title="Pipeline Dependencies" icon="diagram-project" href="/pipelines">
